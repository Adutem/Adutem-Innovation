...
export const Survey = ({}: Props) => {
  ...
  return (
    <>
        ...
        <div className="w-[90%] lg:w-[80%] mx-auto max-w-screen-xl h-full z-20 relative">
          ...
          <div className="h-full flex items-center mt-12">
            <div className="max-w-[800px] flex flex-col mx-auto">
              ...
              <p
                className="capitalize mt-5 md:text-xl text-gray-900 font-semibold max-w-[800px] text-center neue-regular"
              ...
              <p className="font-semibold text-sm text-gray-800 mt-6 flex item-center gap-1 text-center justify-center">
                <i className="fi fi-sr-shield-check flex"></i>
                <span className="-mt-1 neue-regular">Pay-Per-Project</span>
              </p>
              <p className="font-semibold text-sm text-gray-800 mt-2 flex item-center gap-1 text-center justify-center">
                <i className="fi fi-sr-shield-check flex"></i>
      ...
      <div
        ref={shadowBoxRef}
        className="w-[90%] lg:w-[80%] max-w-xl mx-auto bg-white p-4 my-10 mt-12 md:p-8 transition-all duration-300 rounded-lg"
        style={{
          boxShadow:
